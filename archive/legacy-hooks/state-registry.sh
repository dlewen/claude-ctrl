...
STATE_REGISTRY=(
    ...
    ".defprog-gate-strikes|per-session|pre-write.sh|Consecutive defprog-gate violation counter"
    ...
    # --- Tester trace breadcrumb ---
    ".last-tester-trace|per-project|check-tester.sh|Breadcrumb: trace_id written after finalize_trace for post-task.sh to read"
